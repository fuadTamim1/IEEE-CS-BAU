    ...
    <div class="row">
        <div class="col-lg-6">
            <div class=" vl-blog-12-thumb image-anime overflow-hidden _relative">
                <img class="w-full" src="{{ asset("storage/".$blog->image) ?? 'assets/img/blog/blog-page1-image1.png' }}" alt="">
            </div>
        </div>
        <div class="col-lg-6">
            <div class="vl-blog-12-content heading2 h-100">
                ...
                <a href=" blog/{{ $blog->slug }}" class="learn">Read More <span class="arrow1"><i
