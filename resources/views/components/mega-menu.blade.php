                            ...
                            <a href="{{ route('projects') }}">
                                <div class="mega-link-content">
                                    ...
                                    <div class="mega-link-text">
                                        <span class="mega-link-title">Projects</span>
                                        <small class="mega-link-desc">Explore our latest work and innovations</small>
                                    </div>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <div class="mega-link-content">
                                    ...
                                    <div class="mega-link-text">
                                        <span class="mega-link-title">Open Source</span>
                                        <small class="mega-link-desc">Community-driven development</small>
                                    </div>
                                </div>
                            </a>
                        </li>
                            ...
                            <a href="{{ route('events') }}">
                                <div class="mega-link-content">
                                    ...
                                    <div class="mega-link-text">
                                        ...
                                        <small class="mega-link-desc">Join our tech meetups and activities</small>
                                    </div>
                                </div>
                            </a>
                        </li>
                            ...
                            <a href="{{ route('blogs') }}">
                                <div class="mega-link-content">
                                    ...
                                    <div class="mega-link-text">
                                        ...
                                        <small class="mega-link-desc">Tech insights and tutorials</small>
                                    </div>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('resources') }}">
                                <div class="mega-link-content">
                                    ...
                                    <div class="mega-link-text">
                                        <span class="mega-link-title">Resources</span>
                                        <small class="mega-link-desc">Learning materials and guides</small>
                                    </div>
                                </div>
                            </a>
                        </li>
...
@keyframes pixelSmile {
    ...
    85%, 95% { transform: translateX(-50%) scaleX(1.3); }
}
...
document.addEventListener('DOMContentLoaded', function() {
    // Example usage - you'll need to adjust the selectors for your actual trigger element
